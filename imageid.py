...
# print current MATIC account value, and begin polygon or L2 token swap
        balance = web3.eth.getBalance(acct.address)
...
#Actual Swap Code need different "1*10**6" depending on specific token, most are defined as this 1*10**18
        try:
            ...
            tx_hash = uniswap.make_trade(config.L2_token_address, config.L2_weth_address, token_balance, fee=500)
...
#Terminal Display of swap quote
        print("1 usdc value in eth")
#    print(uniswap.get_price_input(token_address, eth, 10**6, fee=500))
        price = (uniswap.get_price_input(config.eth_token_address, eth, 10**6, fee=500)/ (10 ** 18))
        print('%.08f' % price)
